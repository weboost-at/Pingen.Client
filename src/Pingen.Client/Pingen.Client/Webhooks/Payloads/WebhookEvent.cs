...
/// <summary>
/// What every payload Pingen posts to a subscribed URL carries.
/// </summary>
public abstract record WebhookEvent
{
    ...
    /// <summary>
    /// The id of the event - delivery is at-least-once, so deduplicate on it.
    /// </summary>
    [JsonIgnore]
    ...
    /// <summary>
    /// The organisation the event happened in.
    /// </summary>
    [JsonIgnore]
    public Relationship? Organisation { get; init; }

    /// <summary>
    /// The URL Pingen posted the payload to.
    /// </summary>
...
/// <summary>
/// What the payloads about a letter, an email or an ebill carry on top of the base shape.
/// </summary>
public abstract record WebhookDeliverableEvent : WebhookEvent
{
    /// <summary>
    /// The letter, email or ebill the event happened on - its <c>Data.Type</c> names the channel.
    /// </summary>
    [JsonIgnore]
    public Relationship? Deliverable { get; init; }

    /// <summary>
    /// The delivery event the payload was raised for.
    /// </summary>
    [JsonIgnore]
