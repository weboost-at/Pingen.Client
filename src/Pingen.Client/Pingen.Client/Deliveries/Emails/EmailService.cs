...
/// <summary>
/// The email channel - emails are created, cancelled and deleted here, and dispatch happens automatically or through a
/// batch since the channel has no send endpoint.
/// </summary>
public class EmailService(PingenClient client)
{
    /// <summary>
    /// Lists one page of the organisation's emails.
    /// </summary>
    ...
    /// <summary>
    /// Lists the organisation's emails across page boundaries, fetching the next page as the enumeration reaches it.
    /// </summary>
    ...
    /// <summary>
    /// Creates an email from a PDF already uploaded to a presigned URL.
    /// </summary>
    ...
    /// <summary>
    /// Uploads <paramref name="content"/> to a presigned URL and creates an email from it -
    /// <see cref="EmailCreateOptions.FileUrl"/> and <see cref="EmailCreateOptions.FileUrlSignature"/> must be unset
    ...
    /// <summary>
    /// Deletes an email that has not been sent.
    /// </summary>
    ...
    /// <summary>
    /// Cancels an email that is still cancellable.
    /// </summary>
    ...
    /// <summary>
    /// Reads the presigned URL of the email's PDF that the file endpoint answers its redirect with.
    /// </summary>
    ...
    /// <summary>
    /// Downloads the email's PDF - the caller owns the stream and releases the connection by disposing it.
    /// </summary>
    ...
    /// <summary>
    /// Lists one page of the email's events.
    /// </summary>
