...
/// <summary>
/// What an ebill delivery is created from.
/// </summary>
public record EbillCreateOptions
{
    ...
    /// <summary>
    /// Whether the ebill is dispatched as soon as it validates instead of waiting for <c>SendAsync</c>.
    /// </summary>
    [JsonPropertyName("auto_send")]
    public required bool AutoSend { get; init; }

    /// <summary>
    /// The invoice details of the ebill - all four members are required once it is set; leaving it unset makes Pingen
    ...
    /// <summary>
    /// The preset the ebill inherits its defaults from.
    /// </summary>
    [JsonIgnore]
