...
/// <summary>
/// The adjustments the services make to the list options handed to them.
/// </summary>
public static class PingenListOptionsExtensions
{
    ...
    {
        /// <summary>
        /// The same options with <see cref="PingenListOptions.Sort"/> dropped, for the endpoints that accept no sort at
        /// all.
        /// </summary>
