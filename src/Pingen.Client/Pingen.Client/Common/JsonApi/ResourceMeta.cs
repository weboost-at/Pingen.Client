...
{
    /// <summary>
    /// The ability groups as they arrive on the wire - <see cref="Abilities"/> exposes the only group Pingen fills.
    /// </summary>
    [JsonPropertyName("abilities")]
    public ResourceAbilities? AbilityGroups { get; init; }

    /// <summary>
    /// What may be done with this resource, keyed by kebab-case ability name with values <c>ok</c>, <c>state</c> or
    /// <c>permission</c>.
    /// </summary>
    [JsonIgnore]
...
{
    /// <summary>
    /// Abilities on the resource itself.
    /// </summary>
