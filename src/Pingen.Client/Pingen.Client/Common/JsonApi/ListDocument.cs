...
/// <summary>A JSON:API document carrying one page of resources.</summary>
public record ListDocument<TResource>
{
    ...
    /// <summary>The pagination links of this page.</summary>
    [JsonPropertyName("links")]
    public ListLinks? Links { get; init; }

    /// <summary>The pagination counters of this page.</summary>
