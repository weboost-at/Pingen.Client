...
/// <summary>The icon a batch is shown with - the wire names are kebab-case, not snake_case.</summary>
public enum BatchIcon
{
    ...
    /// <summary>A megaphone.</summary>
    [JsonStringEnumMemberName("megaphone")]
    Megaphone,

    /// <summary>A waving hand.</summary>
    [JsonStringEnumMemberName("wave-hand")]
    WaveHand,

    /// <summary>A flash.</summary>
    ...
    /// <summary>A percent tag.</summary>
    [JsonStringEnumMemberName("percent-tag")]
    PercentTag,

    /// <summary>A percent badge.</summary>
    [JsonStringEnumMemberName("percent-badge")]
    PercentBadge,

    /// <summary>A present.</summary>
    ...
    /// <summary>An information sign.</summary>
