...
/// <summary>
/// The organisations the authenticated user is associated with.
/// </summary>
public class OrganisationService(PingenClient client)
{
    ...
    /// <summary>
    /// Lists one page of the organisations the user may act for.
    /// </summary>
    ...
    /// <summary>
    /// Lists the organisations across page boundaries, fetching the next page as the enumeration reaches it.
    /// </summary>
